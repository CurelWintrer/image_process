...
class _CollectionPageState extends State<CollectionPage> {
        ...
        children: [
          ...
          Row(
            children: [
              ...
              SizedBox(width: 16),
              TextButton(onPressed: _cancelSelection, child: Text('退出多选')),
              SizedBox(width: 16),
              IconButton(
  ...
  Future<void> _addImage() async {
    try {
      ...
      ImageModel newImage = ImageModel.fromJson(data['image']);
      ...
      child: Stack(
        children: [
          ...
          GridView.builder(
            ...
            itemCount:
                _images.length + (_hasMore ? 1 : 0) + 1, // 为加载指示器和添加按钮预留位置
